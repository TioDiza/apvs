      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <Reveal>
            ...
            <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">A voz de quem confia na APVS</h3>
            <p className="text-gray-600 text-lg">Não acredite apenas em nós. Veja o que nossos associados têm a dizer sobre nossas entregas.</p>
          </Reveal>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((item, index) => (
            <Reveal key={index} delay={index * 150} animation="fade-up">
              <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-300 relative h-full flex flex-col">
                <Quote className="absolute top-6 right-6 w-10 h-10 text-apvs-green-100" />
                ...
                <p className="text-gray-700 italic flex-grow mb-8 relative z-10">"{item.text}"</p>
